...
xenium_ctx <- readRDS("/xenium_Line61_final/ctx/xenium_CTX_metadata.rds")
...
tg_1_cell_polygons <- xenium_ctx@images$fov.5@boundaries$segmentation@polygons
# extract cell names
...
tg_2_cell_polygons <- xenium_ctx@images$fov.6@boundaries$segmentation@polygons
...
tg_3_cell_polygons <- xenium_ctx@images$fov.7@boundaries$segmentation@polygons
...
tg_4_cell_polygons <- xenium_ctx@images$fov.8@boundaries$segmentation@polygons
...
matching_cells <- intersect(colnames(xenium_ctx), rownames(all_cells_w_pSyn.df))
xenium_ctx$has_pSyn <- NA
xenium_ctx$has_pSyn[matching_cells] <- all_cells_w_pSyn.df[matching_cells, "has_pSyn"]


# save Xenium object

saveRDS(xenium_ctx, file = "/xenium_Line61_final/ctx/xenium_CTX_metadata_pSyn.rds")
