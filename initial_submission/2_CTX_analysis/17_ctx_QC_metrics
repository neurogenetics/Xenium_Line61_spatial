...
meta.df <- as.data.frame(xenium_ctx@meta.data)

################################################################################

# number of cells per sample (Supplementary Fig. 2a)
...
svglite("/xenium_Line61_final/ctx/outs/xenium_ctx_numcellspersample.svg", 
        width = 6, height = 4.5)
plot(p1)
dev.off()
...
# number of transcripts per cell by sample (Supplementary Fig. 2b)
...
svglite("/xenium_Line61_final/ctx/outs/xenium_ctx_numtranscripts.svg", 
...
# number of genes per cell per sample (Supplementary Fig. 2c)
...
svglite("/xenium_Line61_final/ctx/outs/xenium_ctx_numgenes.svg", 
        width = 10.5, height = 5.5)
plot(p3)
dev.off()
...
# negative probe rate per sample (Supplementary Fig. 2d)
...
svglite("/xenium_Line61_final/ctx/outs/xenium_ctx_negproberate.svg", 
        width = 10.5, height = 5.5)
plot(p4)
dev.off()
